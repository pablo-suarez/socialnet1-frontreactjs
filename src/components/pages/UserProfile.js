            ...
            <h5>{userProfile.user.email}</h5>
                <div style={{
                    ...
                    {showFollow?
                     ...
                     <button className="btn waves-effect waves-light" type="submit" name="action" onClick={()=>followUser()}>
                     Seguir
                     </button>

                    :
                    
                    <button className="btn waves-effect waves-light" type="submit" name="action" onClick={()=>unfollowUser()}>
                    Dejar de Seguir
                    </button>
